...
if high_normalization_columns:
    ...
    results_df.to_csv('high_normalization_results_2.csv', index=False)
    print("\nРезультаты сохранены в файл 'high_normalization_results_2.csv'.")
else:
